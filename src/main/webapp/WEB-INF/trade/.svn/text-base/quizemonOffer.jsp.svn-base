...
<h1> Here are your Quizemons</h1>
<h2> </h2>
<form action="<%=application.getContextPath()%>/SubmitOffer.do" method="post">
...
<tr>
 ...
 <%
			...
			<tr>
				<td><input type="checkbox" name="quizemon" value="<%=q.getName()%>"></td>
				<td><%=q.getName()%></td>
...
<%
	...
	<p class="lead">	Reason for offer : </p><input type ="text" name="Reason" value ="Reason" width="400" height="50"  class="form-control" >

<br> 
<br>
		<p align="center">
			<input type="submit" value="Offer Quizemon" align="middle" class="btn btn btn-success ">
		</p>
</form>
