...
<title>Quizemon | View-Trade Form</title>
</head>
<body>
...
<h1>Current Offers</h1>
 ...
 <form action="<%=application.getContextPath()%>/WithdrawOfferServlet.do" method="post">  
	...
	<tr align="center">
           ...
           <a href="<%=request.getContextPath()%>/WithdrawOfferServlet.do?id=<%=tr.getID() %>&qid=<%=tr.getQuizemon()%>" > <button type="button" class="btn btn-success">Withdraw Offer </button> </a> </td>
		</tr>	
